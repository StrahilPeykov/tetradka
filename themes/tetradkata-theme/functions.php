...
function tetradkata_scripts() {
    // Enqueue Dashicons for frontend (IMPORTANT FOR CART ICON)
    wp_enqueue_style('dashicons');
    
    // Enqueue main stylesheet
    wp_enqueue_style('tetradkata-style', get_stylesheet_uri(), array(), '1.0.2');
    ...
    // Enqueue custom CSS
    wp_enqueue_style('tetradkata-custom', get_template_directory_uri() . '/assets/css/custom.css', array('tetradkata-style'), '1.0.2');
    
    // Enqueue Swiper JS
    wp_enqueue_script('swiper-js', 'https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.js', array(), '8.0.0', true);
    
    // Enqueue custom JavaScript
    wp_enqueue_script('tetradkata-scripts', get_template_directory_uri() . '/assets/js/scripts.js', array('jquery', 'swiper-js'), '1.0.2', true);
...
/**
 * Get cart count helper function (works with or without WooCommerce)
 */
...
/**
 * Customize WooCommerce (only if WooCommerce is active)
 */
if (class_exists('WooCommerce')) {
...
/**
 * AJAX Handlers (only if WooCommerce is active)
 */
if (class_exists('WooCommerce')) {
...
/**
 * Custom Meta Boxes (only if WooCommerce is active)
 */
if (class_exists('WooCommerce')) {
...
/**
 * WooCommerce Product Settings (only if WooCommerce is active)
 */
if (class_exists('WooCommerce')) {
