...
<a class="skip-link screen-reader-text" href="#main">
    <?php esc_html_e('Skip to content', 'tetradkata'); ?>
</a>
        ...
        <div class="header-content">
            ...
            <div class="header-cta">
                <?php if (class_exists('WooCommerce')) : ?>
                    <button type="button" class="cart-icon" id="cart-toggle" aria-label="<?php esc_attr_e('Open cart', 'tetradkata'); ?>">
                ...
                <a href="<?php echo esc_url(home_url('/#shop')); ?>" class="btn btn-primary">
                    <?php esc_html_e('Shop Now', 'tetradkata'); ?>
                </a>
            </div>
        </div>
    </div>
...
function tetradkata_primary_menu_fallback() {
    ?>
    <ul class="nav-menu">
        <li><a href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Home', 'tetradkata'); ?></a></li>
        <?php if (class_exists('WooCommerce')) : ?>
            <li><a href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>"><?php esc_html_e('Shop', 'tetradkata'); ?></a></li>
        <?php endif; ?>
        <li><a href="<?php echo esc_url(home_url('/#about')); ?>"><?php esc_html_e('About', 'tetradkata'); ?></a></li>
        <li><a href="<?php echo esc_url(home_url('/#contact')); ?>"><?php esc_html_e('Contact', 'tetradkata'); ?></a></li>
    </ul>
    <?php
}
?>